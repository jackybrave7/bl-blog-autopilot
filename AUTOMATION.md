...
- **Фокус контента** (`config/content_focus.yaml`): только иллюстрация, живопись, техники, материалы, гайды; Creative Boom и маркетинговые ленты отключены; статьи без художественной темы пропускаются на `fetch`, `translate` и `publish`
